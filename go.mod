...
replace github.com/sagernet/sing-box v1.13.0 => github.com/awkys/sing-box_mod v1.13.0-alpha.5.0.20251202212447-8d054dcd8bfe

replace github.com/xtls/xray-core v1.251202.0 => github.com/awkys/xray-core v0.0.0-20251202200223-63db1dc9e9e2
